...
```sh
npm install @patrtorg/minus-harum-explicabo
```

## Usage

```js
const tildify = require('@patrtorg/minus-harum-explicabo');
...
See [un@patrtorg/minus-harum-explicabo](https://github.com/mehmetcanfarsak/un@patrtorg/minus-harum-explicabo) for the inverse.
